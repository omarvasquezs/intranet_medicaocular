...
$routes->get('firmar_amonestacion/(:num)', 'Amonestaciones::firmarAmonestacion/$1');
$routes->get('check_amonestacion_status/(:num)', 'Amonestaciones::checkAmonestacionStatus/$1');
